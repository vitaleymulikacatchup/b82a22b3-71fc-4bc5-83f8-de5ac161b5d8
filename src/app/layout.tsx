...
export const metadata: Metadata = {
  ...
  description: "Experience elevated cuisine at Gloria. Award-winning restaurant serving exquisite dishes in an elegant atmosphere. Reserve your table today.",
  keywords: "fine dining, restaurant, upscale cuisine, reservations, elegant dining",
  metadataBase: new URL("https://gloria-restaurant.com"),
  alternates: {
    canonical: "https://gloria-restaurant.com"
  },
  openGraph: {
    title: "Gloria Restaurant - Fine Dining Excellence",
    description: "Experience elevated cuisine at Gloria. Award-winning restaurant serving exquisite dishes in an elegant atmosphere.",
    url: "https://gloria-restaurant.com",
